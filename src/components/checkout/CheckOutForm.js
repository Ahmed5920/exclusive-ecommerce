const CheckOutForm = () => {
  const inputClass =
    "bg-gray-100 py-3 px-3 w-full md:w-[500px] text-left border border-transparent focus:border-none focus:bg-gray-200 rounded-md";

  return (
    <form className="space-y-6 flex flex-col px-2 md:px-0 w-full md:w-auto">
