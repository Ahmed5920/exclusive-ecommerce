...
const CheckOutAction = () => {
  ...
  return (
    <Fragment>
      <div className="w-full md:w-[560px] p-4 mt-6 md:mt-24 md:ml-8 bg-white rounded-lg">
        {/* Cart Items */}
        {cart.map((product) => {
          let productImage;
          try {
          ...
          return (
            <div
              className="grid grid-cols-[auto_1fr_auto] items-center gap-x-4 py-3 border-b md:border-none"
              key={product.id}
            >
        ...
        <div className="mt-6 space-y-4">
          <label className="flex items-center justify-between md:justify-start gap-4 cursor-pointer">
            ...
            <img src={visaCard} alt="Visa" className="w-10 h-6 md:ml-40" />
          </label>
          ...
          <button
            className="text-white bg-red-500 py-3 px-8 rounded-md w-full md:w-auto focus:bg-red-700 transition duration-200"
