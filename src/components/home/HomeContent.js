      ...
      <div className="flex flex-wrap gap-4 md:gap-8 mt-8 md:mt-16 justify-center items-center px-4">
        {[
          ...
          <Link
            key={to}
            to={to}
            className="flex flex-col items-center border p-8 md:p-12 w-32 md:w-60 hover:bg-red-500 h-[137.6px] md:h-full hover:text-white cursor-default rounded-md text-center"
          >
