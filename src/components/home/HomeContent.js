      ...
      <div className="flex flex-wrap gap-4 md:gap-8 mt-8 md:mt-16 justify-center items-center px-4">
        {[
          ...
          <Link
            key={to}
            to={to}
            className="flex flex-col items-center border p-6 md:p-12 w-36 md:w-60 hover:bg-red-500 hover:text-white cursor-default rounded-md text-center"
          >
            <Icon size={40} className="hover:text-white" />
